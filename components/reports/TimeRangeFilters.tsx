...
export default function TimeRangeFilters() {
    ...
    return (
        <div className="bg-card border rounded-lg p-6 space-y-4">
            <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Global Time Filter</h2>
            <div className="flex flex-col md:flex-row md:items-end gap-6">
                ...
                <Button variant="outline" className="w-full md:w-auto" onClick={() => updateFilters("", "")}>Reset Date</Button>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
                ...
                <Button variant="secondary" size="sm" onClick={() => setThisMonth()}>This Month</Button>
            </div>
        </div>
    );
}
